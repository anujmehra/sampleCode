...
public class CreateParquetForImpalaFlightMaster {
    ...
    public static void main(final String args[]){
        ...
        final String inputPath = "/home/admin/am/master/flightmaster/Flight_Master.parquet";
        final Dataset<Row> input = sparkSession.read().parquet(inputPath);
        final JavaRDD<Row> inputRowJavaRDD = input.javaRDD();

        final String outputPath = "/home/admin/am/english_masters/Flight_Master_english.parquet";
